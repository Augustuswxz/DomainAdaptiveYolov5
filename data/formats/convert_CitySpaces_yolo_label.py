...
if __name__ == "__main__":
    ...
    for image_set in ["train", "val"]:
        ...
        ori_imgs_path = os.path.join(data_root_path, "leftImg8bit", image_set)
        ori_anno_path = os.path.join(data_root_path, "gtFine", image_set)
        ...
        for city_name in tqdm(city_names):
            ...
            for img_name in os.listdir(ori_imgs_path_city):
                ...
                id = img_name.replace("_leftImg8bit.png", "")
...
'''
train --> error_list: 10
 ['monchengladbach_000000_015561_Nolabel', 'weimar_000067_000019_Nolabel', 'weimar_000097_000019_Nolabel', 'dusseldorf_000106_000019_Nolabel', 'dusseldorf_000101_000019_Nolabel', 'bochum_000000_031152_Nolabel', 'strasbourg_000000_023854_Nolabel', 'strasbourg_000000_012934_Nolabel', 'strasbourg_000000_036016_Nolabel', 'strasbourg_000000_035571_Nolabel']
val --> error_list: 8
 ['lindau_000045_000019_Nolabel', 'lindau_000040_000019_Nolabel', 'lindau_000019_000019_Nolabel', 'lindau_000017_000019_Nolabel', 'lindau_000032_000019_Nolabel', 'lindau_000018_000019_Nolabel', 'lindau_000049_000019_Nolabel', 'lindau_000021_000019_Nolabel']
[OK] finished one dataset /datasdc/zhouhuayi/dataset/domain_adaptation/CityScapes
...
all class names in CityScapes are:
 {'train', 'wall', 'pole', 'rail track', 'out of roi', 'rider', 'vegetation', 'dynamic', 'trailer', 'motorcycle', 'polegroup', 'static', 'person', 'guard rail', 'bicycle', 'ridergroup', 'license plate', 'bridge', 'traffic light', 'bicyclegroup', 'building', 'cargroup', 'road', 'ground', 'car', 'truckgroup', 'rectification border', 'ego vehicle', 'sky', 'motorcyclegroup', 'fence', 'sidewalk', 'parking', 'tunnel', 'traffic sign', 'persongroup', 'bus', 'terrain', 'caravan', 'truck'}
