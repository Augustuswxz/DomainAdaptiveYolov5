...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='D:/PycharmProjects/SSDA-YOLO/weights/yolov5s.pt', help='initial weights path')
    ...
    parser.add_argument('--name', default='myssdayolo', help='save to project/name')
    ...
    parser.add_argument('--save_period', type=int, default=3, help='Log model after every "save_period" epoch')
