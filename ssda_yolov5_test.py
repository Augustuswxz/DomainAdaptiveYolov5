...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/myssdayolo34/weights/best_student.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='ssdayolotest', help='save to project/name')
